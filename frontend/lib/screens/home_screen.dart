...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final Map<String, RecommendationsResponse> _responseCache = <String, RecommendationsResponse>{};
  ...
  Future<RecommendationsResponse> _loadRecommendations({bool forceRefresh = false}) {
    if (!forceRefresh) {
    ...
    final future = widget.api.fetchRecommendations(group: _selectedGroup.id).then((response) {
    ...
    return Scaffold(
      ...
      body: FutureBuilder<RecommendationsResponse>(
        ...
        builder: (
          ...
          if (data == null) {
            return ErrorState(message: 'No data received.', onRetry: () => _retry(forceRefresh: true));
          }

          return ValueListenableBuilder<Set<String>>(
            valueListenable: _favoritesStore.favorites,
            builder: (BuildContext context, Set<String> favorites, Widget? child) {
              ...
              onTap: () {
                Navigator.of(context).push(
                  MaterialPageRoute<void>(
                    builder: (BuildContext context) => StockDetailScreen(symbol: item.symbol, api: api),
                  ),
                );
              },
            ),
